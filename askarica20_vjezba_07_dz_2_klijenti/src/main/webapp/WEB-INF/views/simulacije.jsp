<%@page
	import="edu.unizg.foi.nwtis.askarica20.vjezba_08_dz_3.podaci.Vozilo"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@ page
	import="java.util.List,java.util.Date,java.text.SimpleDateFormat,edu.unizg.foi.nwtis.askarica20.vjezba_08_dz_3.podaci.Kazna"%>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>REST MVC - Pregled voznji - RestKlijentSimulator</title>
<style type="text/css">
table, th, td {
	border: 1px solid;
}
...
<body>
	<h1>REST MVC - Pregled voznji - RestKlijentSimulator</h1>
	<ul>
		<li><a
